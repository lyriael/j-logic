...
Still the source code attached \todo{attached? Will the source code be attached??} is provided with a full documentation, not only containing method description but also rich in line comments, examples and explanations. 
